 <?php
    ...
    $q = mysqli_query($conn, "INSERT INTO users(username, password, fname, mname, lname, address, email, phone, role) VALUES('$username', '$password', '$fname', '$mname', '$lname', '$address', '$email', '$phone', 'company')");
     if($q){
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="card-body" style="border-right : 1px solid black;">
                        <a href="register-customer.php" class="nav-link text-dark"><i class="fa fa-user-plus"></i> Customer</a>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="card-body">
                        <a href="register.php" class="nav-link text-danger"><i class="fa fa-home"></i> Service Provider</a>
                      </div>
                    </div>
                  </div>
                  </div>
