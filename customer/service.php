...
if(isset($_POST['reserve-car'])){
  ...
  if(isset($_POST['reserve-plane'])){
        ...
        if(isset($_POST['reserve-tour'])){
             ...
             $price = $tprice + $fprice + $rprice;


            $qry_insert = "INSERT INTO tour_res(tid, rid, fid, price, username) VALUES('$tid', '$rid', '$fid', '$price', '$username')";
            $ext = mysqli_query($conn,$qry_insert);
  ...
  if(isset($_POST['reserve-cinema'])){
      ...
      if(isset($_POST['reserve-food'])){
            ...
            if(isset($_POST['reserve-room-tour'])){
              $_SESSION['rid'] = $_POST['rid'];

            }

            if(isset($_POST['reserve-food-tour'])){
                ...
                <tbody>
                  ...
                  $num = 1;
                   ...
                   while($row = mysqli_fetch_array($ext)){
                    if(strtotime(date("Y-m-d")) <= strtotime($row['fdate'])){
                  ?>
                <tr>
                  <td><?php echo $num; ?></td>
                  ...
                  <td>&nbsp; <a href="service.php?reserve-car=<?php echo $row['pid']; ?>"><i class="fa fa-plus" style="color: blue;" title="Reserve"></i></a> &nbsp;</td>
                </tr><?php } $num++;
              }?>
                </tbody>
                <tfoot>
        ...
        <div class="card card-light">
              ...
              <table class="table table-bordered table-striped example1">
                ...
                <tbody>
                  <?php
                  $num = 1;
                   $qry = "SELECT tour.tid, tour.sdate, tour.edate, tour.location AS 'tlocation', tour.tguide, tour.price, service.sid, service.oname, service.location FROM tour JOIN service ON tour.sid = service.sid";
                   $ext = mysqli_query($conn,$qry);
                ...
                <tr>
                  ...
                  <td><?php echo $row['price']?></td>
                  <!-- <td><?php echo $row['tguide']?></td> -->
                  <td>&nbsp; <a href="service.php?add-room-ser=<?php echo $row['sid']."&tid=".$row['tid']."&room"; ?>"><i class="fa fa-plus" style="color: blue;" title="Add Room"></i></a> &nbsp; | &nbsp; <a href="service.php?add-food-ser=<?php echo $row['sid']."&toid=".$row['tid']."&food"; ?>"><i class="fa fa-plus" style="color: red;" title="Add Food"></i></a> | &nbsp; <a href="service.php?res-tour=<?php echo $row['sid']."&tid=".$row['tid']; ?>"><i class="fa fa-check" style="color: black;" title="Add Food"></i></a></td>
                </tr><?php $num++;
              }?>
                </tbody>
                <tfoot>
              ...
              <table class="table table-bordered table-striped example1">
                ...
                <tbody>
                  ...
                  $num = 1;
                   ...
                   while($row = mysqli_fetch_array($ext)){
                    if(strtotime(date("Y-m-d")) <= strtotime($row['wdate'])){
                  ?>
                <tr>
                  <td><?php echo $num; ?></td>
                  <td><?php echo $row['oname'];?></td>
                  ...
                  <td>&nbsp; <a href="service.php?reserve-cinema=<?php echo $row['cid']; ?>"><i class="fa fa-plus" style="color: blue;" title="Book"></i></a> &nbsp;</td>
                </tr><?php } $num++;
              }?>
                </tbody>
                <tfoot>
...
<?php } if(isset($_GET['food'])){
    ...
    if(isset($_GET['add-food-ser'])){
    $_SESSION['fo'] = $_GET['add-food-ser'];
        ...
        <div class="card card-light">
              ...
              <table class="table table-bordered table-striped example1">
                ...
                <tr>
                  ...
                  <td>&nbsp; <a href="service.php?reserve-food=<?php echo $row['fid']; ?>"><i class="fa fa-plus" style="color: blue;" title="Order"></i></a> &nbsp;</td>
                </tr><?php $num++;
              }?>
                </tbody>
                <tfoot>
...
if(isset($_GET['add-room-ser']) && isset($_GET['tid'])){
    $_SESSION['ro'] = $_GET['add-room-ser'];
    $_SESSION['toid'] = $_GET['tid'];
  }
        ...
        <div class="card card-light">
              ...
              <table class="table table-bordered table-striped example1">
                ...
                <tr>
                  ...
                  <td><?php echo $row['price'];?></td>
                  <td>&nbsp; <a href="service.php?reserve-room=<?php echo $row['rid']; ?>"><i class="fa fa-plus" style="color: blue;" title="Reserve Room"></i></a> &nbsp;</td>
                </tr><?php
              $num++; }?>
                </tbody>
                <tfoot>
        ...
        <div class="card card-light">
              ...
              <table class="table table-bordered table-striped example1">
                ...
                <tr>
                  ...
                  <td>&nbsp; <a href="service.php?reserve-plane=<?php echo $row['pid']; ?>"><i class="fa fa-plus" style="color: blue;" title="Reserve"></i></a> &nbsp;</td>
                </tr><?php } $num++;
              }?>
                </tbody>
                <tfoot>
...
<?php } if(isset($_GET['reserve-car'])){
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              <li class="breadcrumb-item"><a href="index.php"><i class="fas fa-home"></i></a> / <a href="#" style="cursor: unset;">Services </a> / <a href="#" style="cursor: unset;">Book Tour</a></li>
            </ol>
          </div><!-- /.col -->
        </div>
        </div>
          ...
          <?=$msg;?>
      <form role="form" action="service.php?tour" method="POST">
        <div class="card card-light">
              <div class="card-header">
                <h3 class="card-title">Book Tour</h3>
                <a href="service.php?tour" class="float-sm-right" title="View Tour"><i class="fa fa-eye"></i></a>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
           ...
           <div class="card-body">
                  ...
                  $price = 0;
                    $qry = "SELECT tour.tid, tour.sdate, tour.edate, tour.location AS 'tlocation', tour.price, tour.tguide, tour.sid, service.sid, service.oname, service.location FROM tour JOIN service ON tour.sid = service.sid AND tour.tid = '".$_GET['tid']."'";
                    $ext = mysqli_query($conn,$qry);
                    while($row = mysqli_fetch_array($ext)){
                  ?>
                  ...
                  <div class="form-group col-sm-6">
                    ...
                    <input type="text" class="form-control" name="from" value="Starting Date : <?php echo $row['sdate'] ?>" readonly>
                    <input type="hidden" class="form-control" name="tid" value="<?php echo $row['tid']; ?>">
                    <input type="hidden" class="form-control" name="sid" value="<?php echo $row['sid']; ?>">
                  </div>
                  <div class="form-group col-sm-6">
                    <input type="text" class="form-control" name="to" value="Ending Date : <?php echo $row['edate'] ?>" readonly>
                  </div>
                  <div class="form-group col-sm-6">
                    <input type="text" class="form-control" name="location" value="Tour Location : <?php echo $row['tlocation'] ?>" readonly>
                  </div>
                  <?php if(isset($_SESSION['rid'])) { ?>
                    <?php $sel = mysqli_query($conn, "SELECT *FROM room WHERE rid = '".$_SESSION['rid']."'"); $rowr = mysqli_fetch_array($sel);  ?>
                  <div class="form-group col-sm-6">
                    <input type="text" class="form-control" name="rtype" value="Room Type : <?php echo $rowr['rtype'] ?>" readonly>
                  </div>
                  <div class="form-group col-sm-6">
                    <input type="text" class="form-control" value="Room Price : <?php echo $rowr['price'] ?>" readonly>
                    <input type="hidden" class="form-control" name="rprice" value="<?php echo $rowr['price'] ?>">
                  </div>  <?php } ?>
                  <?php if(isset($_SESSION['fid'])) { ?>
                    <?php $sel2 = mysqli_query($conn, "SELECT *FROM food WHERE fid = '".$_SESSION['fid']."'"); $rowr2 = mysqli_fetch_array($sel2);  ?>
                  <div class="form-group col-sm-6">
                    <input type="text" class="form-control" name="rtype" value="Food Name : <?php echo $rowr2['fname'] ?>" readonly>
                  </div>
                  <div class="form-group col-sm-6">
                    <input type="text" class="form-control" value="Food Price : <?php echo $rowr2['fprice'] ?>" readonly>
                    <input type="hidden" class="form-control" name="fprice" value="<?php echo $rowr2['fprice'] ?>" readonly>
                  </div>  <?php } ?>
                  <div class="form-group col-sm-6">
                    <input type="text" class="form-control" name="tguider" value="Tour Guider : <?php echo $row['tguide'] ?>" readonly>
                  </div>
                  <div class="form-group col-sm-6">
                    <input type="text" class="form-control" value="Tour Price : <?php echo $row['price'] ?>" readonly>
                    <input type="hidden" class="form-control" name="tprice" value="<?php echo $row['price'] ?>" readonly>
                  </div>
                </div>
                </div>
                  <div class="col-sm-5">
                ...
                <div class="card-footer">
                  <button type="submit" name="reserve-tour" class="btn btn-primary">Reserve</button>
                </div>
            </div>
          </form>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <?=$msg;?>
      <form role="form" <?php if(isset($_SESSION['fo']) && ($_SESSION['fo'] != 0)){ ?> action="service.php?tour" <?php } else { ?> action="service.php?food" <?php } ?> method="POST">
        <div class="card card-light">
              <div class="card-header">
           ...
           <div class="card-body">
                ...
                <div class="card-footer">
                  <?php if(isset($_SESSION['fo']) && ($_SESSION['fo'] != 0)){ ?><button type="submit" name="reserve-food-tour" class="btn btn-primary">Order for Tour</button> <?php } else { ?> <button type="submit" name="reserve-food" class="btn btn-primary">Order</button> <?php } ?>
                </div>
            </div>
          </form>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <?=$msg;?>
      <form role="form" <?php if(isset($_SESSION['toid']) && ($_SESSION['toid'] != 0)){ ?> action="service.php?tour" <?php } else { ?> action="service.php?room" <?php } ?> method="POST">
        <div class="card card-light">
              <div class="card-header">
                <h3 class="card-title">Reserve Room</h3>
                <a href="service.php?room" class="float-sm-right" title="View Room"><i class="fa fa-eye"></i></a>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
           ...
           <div class="card-body">
                ...
                <div class="card-footer">
                  <?php if(isset($_SESSION['toid']) & ($_SESSION['toid'] != 0)){ ?> <button type="submit" name="reserve-room-tour" class="btn btn-primary">Book For Tour </button><?php } else{ ?> <button type="submit" name="reserve-room" class="btn btn-primary">Book</button><?php } ?>
                </div>
            </div>
          </form>
