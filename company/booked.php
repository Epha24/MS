        ...
        <div class="card card-light">
              ...
              <table class="table table-bordered table-striped example1">
                ...
                <tbody>
                  <?php
                  $num = 1;
                   $qry = "SELECT car_res.resid, car_res.cid, car_res.sno, car.pid, car.tno, car.model, car.tsno, car.from_s, car.to_s, car.price FROM car_res JOIN car ON car.pid = car_res.cid";
