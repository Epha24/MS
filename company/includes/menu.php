...
<div class="wrapper">
        ...
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"><img src="../pic/user.png" class="user-image" alt="User Image"></a>
          <ul class="dropdown-menu">
            <li class="user-header bg-info">
              ...
              <p><span id="user"><?php echo user(); ?></span> - Company</p>
            </li>
            <li class="user-body">
              <div class="row">
                <div class="pull-left">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link" title="">
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="brand-text font-weight-light"><i class="fas fa-stream"></i> E-Service</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview <?php if($cur == "services"){ echo 'active'; } ?>">
            <a href="services.php?add-service" class="nav-link" <?php if($cur == 'services'){ echo 'id="act"'; } ?>>
          ...
          <li class="nav-item has-treeview <?php if($cur == "orders"){ echo 'active'; } ?>">
            <a href="booked.php?car" class="nav-link" <?php if($cur == 'orders'){ echo 'id="act"'; } ?>>
              <i class="nav-icon fas fa-th-list"></i>
              <p>
                Orders
              </p>
